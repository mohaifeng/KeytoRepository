...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef *tim_encoderHandle)
{
	...
	if(tim_encoderHandle->Instance == TIM2)
	{
		...
		/**TIM2 GPIO Configuration
		 ...
		 PB3     ------> TIM2_CH2
		 */
		GPIO_InitStruct.Pin = ENCODE_ETR_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStruct.Alternate = GPIO_AF14_TIM2;
		HAL_GPIO_Init(ENCODE_ETR_GPIO_Port,&GPIO_InitStruct);

		GPIO_InitStruct.Pin = ENCODE_CH1_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
		HAL_GPIO_Init(ENCODE_CH1_GPIO_Port,&GPIO_InitStruct);

		GPIO_InitStruct.Pin = ENCODE_CH2_Pin;
		GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
		GPIO_InitStruct.Pull = GPIO_NOPULL;
		GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
		HAL_GPIO_Init(ENCODE_CH2_GPIO_Port,&GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef *tim_encoderHandle)
{
	...
	if(tim_encoderHandle->Instance == TIM2)
	{
		...
		/**TIM2 GPIO Configuration
		 ...
		 PB3     ------> TIM2_CH2
		 */
		HAL_GPIO_DeInit(GPIOA,ENCODE_ETR_Pin | ENCODE_CH1_Pin);

		HAL_GPIO_DeInit(ENCODE_CH2_GPIO_Port,ENCODE_CH2_Pin);
