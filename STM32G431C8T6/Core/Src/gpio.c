...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_BLUE_Pin|TMC_STEP_Pin|TMC_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DRV_ENN_Pin LED_BLUE_Pin */
  GPIO_InitStruct.Pin = DRV_ENN_Pin|LED_BLUE_Pin;
