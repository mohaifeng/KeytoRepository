...
if __name__ == '__main__':
    ...
    # Cmd_E(0,
    #       '10Wr200,8888|10Wu1,1|10Wu2,3000|10Wu3,200|10Wu4,512000|10Wu5,512000|10Wu6,200000|10Wu7,0|10Wu8,1280|10Wu9,'
    #       '1920|10Wu10,64|10Wu11,430000|10Wu12,0|10Wu13,5000|10Wu14,4000|10Wu15,56200|10Wu16,1000|10Wu17,100|10Wu18,'
    #       '1000|10Wu19,700|10Wu20,1|10Wu21,0|10Wu22,10000|10Wu23,100|10Wu24,500|10Wu25,50000|10Wu26,100|10D0x9F10,0,0|',
    #       True)
    # Cmd_E(0, '10RST123456', False)
    # time.sleep(6)
    Group_ArmAxis_Init(0, 10, True, 50)
    Group_ArmAxis_Init(0, 11, True, 50)
    time.sleep(2)
    Group_ArmAxis_MovePos(0, 10, True, 136, 200)
    time.sleep(2)
    startpos = GetPos()
    ...
    for j in range(0, 1000):
        real_data = []
        target_pos = random.randint(0, 430)
        # real_data.append(target_pos)
        Group_ArmAxis_MovePos(0, 10, True, target_pos, 200)
        time.sleep(2)
        Group_ArmAxis_MovePos(0, 10, True, 136, 200)
        time.sleep(2)
        end_pos = GetPos()
        pian = abs(end_pos - startpos)
        if pian > 200:
            print('目标:', startpos)
            print('实测:', end_pos)
            print('偏差:', pian)
    ...
    #     real = abs(end_pos - startpos)
    #     real_data.append(real)
    #     cha = abs(real - (target_pos * 1000))
    #     real_data.append(cha)
